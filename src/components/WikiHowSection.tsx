...
const WikiHowSection = () => (
    <section id="guidelines" className="bg-slate-50 py-24 border-t border-slate-100 flex-1 flex flex-col justify-center overflow-hidden">
        {/* Entrance Animation */}
        <div className="container max-w-6xl px-4 animate-in fade-in slide-in-from-bottom-8 duration-700">

            {/* Section Header */}
            <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E4EB9C]/50 text-[#142C14] text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                    Official Reference
                </div>
                <h2 className="font-heading text-3xl md:text-4xl font-black text-[#2D5128] mb-4">
            ...
            <h3 className="font-heading font-black text-2xl mb-8 text-slate-900 flex items-center gap-3 border-b border-slate-200 pb-4">
                <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#E4EB9C]/50 text-[#2D5128] text-sm">1</span>
                Exposure Scenarios (PH Classification)
            </h3>

            <div className="grid md:grid-cols-3 gap-6 mb-20">
                {/* Category I */}
                <div className="bg-white border border-slate-100 rounded-3xl p-8 flex flex-col shadow-sm hover:shadow-xl transition-shadow group hover:border-[#2D5128]/30">
                    ...
                    <h4 className="font-heading font-black text-slate-900 mb-4 flex items-center gap-2 text-xl">
                        <CheckCircle2 size={24} className="text-[#2D5128]" /> Category I
                    </h4>
                    ...
                    <div className="mt-auto bg-[#E4EB9C]/40 text-[#2D5128] text-xs font-black uppercase tracking-wider px-4 py-3 rounded-xl w-fit">
                        No vaccine needed
                    </div>
                </div>

                {/* Category II */}
                <div className="bg-white border-2 border-[#8DA750]/40 rounded-3xl p-8 flex flex-col shadow-sm hover:shadow-xl transition-shadow group relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-16 h-16 bg-[#E4EB9C]/30 rounded-bl-full -z-10"></div>
                    <div className="w-full h-48 bg-slate-100 rounded-2xl mb-8 overflow-hidden group-hover:scale-[1.02] transition-transform">
                        <img src={category2} alt="Category II Exposure" className="w-full h-full object-cover object-center" />
                    </div>
                    <h4 className="font-heading font-black text-slate-900 mb-4 flex items-center gap-2 text-xl">
                        <AlertTriangle size={24} className="text-[#537B2F]" /> Category II
                    </h4>
                    <ul className="text-sm text-slate-600 space-y-3 mb-8 list-disc pl-5">
                        <li><strong className="text-slate-900">Nibbling of uncovered skin</strong></li>
                        <li>Minor scratches (no bleeding)</li>
                    </ul>
                    <div className="mt-auto bg-[#E4EB9C]/20 border border-[#8DA750]/20 text-[#537B2F] text-xs font-black uppercase tracking-wider px-4 py-3 rounded-xl w-fit">
                        Needs Vaccine
                    </div>
                </div>

                {/* Category III */}
                <div className="bg-white border-2 border-[#142C14]/20 rounded-3xl p-8 flex flex-col shadow-sm hover:shadow-xl transition-shadow group relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-16 h-16 bg-[#142C14]/5 rounded-bl-full -z-10"></div>
                    <div className="w-full h-48 bg-slate-100 rounded-2xl mb-8 overflow-hidden group-hover:scale-[1.02] transition-transform">
                        <img src={category3} alt="Category III Exposure" className="w-full h-full object-cover object-center" />
                    </div>
                    <h4 className="font-heading font-black text-slate-900 mb-4 flex items-center gap-2 text-xl">
                        <AlertOctagon size={24} className="text-[#142C14]" /> Category III
                    </h4>
                    <ul className="text-sm text-slate-600 space-y-3 mb-8 list-disc pl-5">
                    ...
                    <div className="mt-auto bg-[#142C14]/10 text-[#142C14] text-xs font-black uppercase tracking-wider px-4 py-3 rounded-xl w-fit">
                        Needs Vaccine + RIG
                    </div>
                </div>
            </div>
            ...
            {/* Part 2: Step-by-Step */}
            <h3 className="font-heading font-black text-2xl mb-8 text-slate-900 flex items-center gap-3 border-b border-slate-200 pb-4">
                <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#E4EB9C]/50 text-[#2D5128] text-sm">2</span>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-8 lg:p-10 shadow-lg">
                    <h4 className="font-heading font-black text-2xl mb-8 text-slate-900 flex items-center gap-3">
                        <div className="w-3 h-8 bg-[#2D5128] rounded-full"></div>
                        ...
                        <ul className="space-y-6 text-sm text-slate-600">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#537B2F] block mt-2 font-medium italic">Rationale: Avoid repeated exposure.</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[#E4EB9C]/50 flex items-center justify-center font-bold text-[#2D5128]">2</span>
                                <div>
                                    ...
                                    <span className="text-[#537B2F] block mt-2 font-medium italic">Rationale: Physically removes virus before it enters nerves. Can reduce infection risk by up to 90%.</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#537B2F] block mt-2 font-medium italic">Rationale: Helps flush contaminants.</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#537B2F] block mt-2 font-medium italic">Rationale: Inactivates virus locally.</span>
                                </div>
                            </li>
                        </ul>
                            ...
                            <ul className="space-y-6 text-sm text-slate-600">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[#537B2F] block mt-2 font-medium italic">If animal remains healthy, it may influence continuation of treatment.</span>
                                    </div>
                                </li>
                            </ul>

                            {/* Warning Box */}
                            <div className="bg-[#142C14]/5 border-l-4 border-[#142C14] p-6 rounded-r-2xl mt-8">
                                <strong className="text-[#142C14] font-black flex items-center gap-2 mb-3">
                                    <AlertTriangle size={18} /> DO NOT DO THIS:
                                </strong>
                                <ul className="list-disc pl-5 space-y-2 text-[#142C14]/80 text-sm font-medium">
                                ...
                                <span className="text-[#142C14]/60 font-bold text-xs block mt-4 uppercase tracking-wider">Rationale: These trap the virus inside.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    {/* Scenario 2 */}
                    <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col hover:border-[#8DA750]/50 transition-colors">
                        ...
                        <h4 className="font-heading font-black text-xl mb-4 text-[#2D5128]">Scenario 2: Animal Scratch</h4>
                    ...
                    <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col hover:border-[#8DA750]/50 transition-colors">
                        ...
                        <h4 className="font-heading font-black text-xl mb-4 text-[#2D5128]">Scenario 3: Lick on Open Wound</h4>
                        <ul className="space-y-3 text-sm text-slate-600 flex-1">
                        ...
                        <div className="mt-6 bg-[#142C14]/5 p-4 rounded-xl border border-[#142C14]/20 text-xs font-bold text-[#142C14] flex items-start gap-3">
                    ...
                    <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col hover:border-[#8DA750]/50 transition-colors">
                        ...
                        <h4 className="font-heading font-black text-xl mb-4 text-[#2D5128]">Scenario 4: Saliva to Eyes/Mouth/Nose</h4>
                    ...
                    <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col hover:border-[#8DA750]/50 transition-colors">
                        ...
                        <h4 className="font-heading font-black text-xl mb-4 text-[#2D5128]">Scenario 5 & 6: Bat Exposure & Cuts</h4>
