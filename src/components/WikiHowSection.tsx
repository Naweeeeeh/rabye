    ...
    >
        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <h3 className="font-heading font-black text-2xl mb-8 text-white flex items-center gap-3 border-b border-white/10 pb-4">
                {t("Exposure Categories (PH Classification)")}
            </h3>
                        ...
                        <ul className="space-y-6 text-sm text-[#142C14]/70">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#8DA750] block mt-2 font-bold italic">{t("Why: Avoid repeated exposure.")}</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#8DA750] block mt-2 font-bold italic">{t("Why: Physically removes virus before it enters nerves. Can reduce infection risk by up to 90%.")}</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-[#8DA750] block mt-2 font-bold italic">{t("Why: Helps flush contaminants.")}</span>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                ...
                                <div>
                                    <strong className="text-[#142C14] block text-base mb-1 font-black">{t("Apply alcohol/betadine.")}</strong>
                                    {t("Preferred: Povidone-iodine. Alternatives: alcohol, chlorhexidine.")}<br/>
                                    <span className="text-[#8DA750] block mt-2 font-bold italic">{t("Why: Inactivates virus locally.")}</span>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div className="space-y-6 flex flex-col">
                            <ul className="space-y-6 text-sm text-[#142C14]/70 flex-1">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <strong className="text-[#142C14] block text-base mb-1 font-black">{t("Go to nearest ABTC as soon as possible.")}</strong>
                            ...
                            <div className="bg-red-50 border border-red-100 p-6 rounded-2xl mt-8">
                                ...
                                <span className="text-red-700/60 font-black text-[10px] block mt-4 uppercase tracking-wider">{t("Why: These trap the virus inside.")}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="group relative bg-white rounded-[2.5rem] p-6 flex flex-col shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[#142C14]/50">
                        ...
                        <div className="px-2 flex flex-col flex-1">
                            ...
                            <ul className="space-y-3 text-sm text-[#142C14]/70 flex-1 font-medium">
                                ...
                                <li><strong className="text-[#142C14] font-black mr-2">{t("Step 2:")}</strong> {t("Apply alcohol/betadine.")}</li>
                        ...
                        <div className="px-2 flex flex-col flex-1">
                            ...
                            <ul className="space-y-6 text-sm text-[#142C14]/70 flex-1 font-medium">
                                ...
                                <li className="pt-4 border-t border-slate-100">
                                    ...
                                    {t("Wash thoroughly (15 minutes), apply alcohol/betadine, assess wound exposure, and consult healthcare provider.")}
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="mt-24 pt-12 border-t border-white/10 flex flex-col items-center text-center">
                <h3 className="font-heading font-black text-2xl md:text-3xl text-white mb-6">
                    {t("Need more detailed information?")}
                </h3>
                <a
                ...
                >
                    ...
                    {t("Read Official DOH Guidelines")}
                ...
                <p className="mt-5 text-xs font-medium text-white/50 tracking-wide">
                    {t("Links directly to the official Department of Health (DOH) Philippines website.")}
                </p>
            </div>
